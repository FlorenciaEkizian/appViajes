...
var validator = (function($){
    ...
    */
    message = {
        ...
        password_repeat : 'la clave no coincide',
        repeat          : 'no match',
    ...
    */
    mark = function( field, text ){
        ...
        setTimeout(function(){
	        ...
	        field.css({'border': '2px solid #CE5454'});
	
			//CODIGO ORIGINAL, parece no estar llegando a la clase de css .bad / para el tema del mensaje de tipo de error tampoco lo muestra, está en "text"
    ...
    */
    unmark = function( field ){
        ...
        //AQUI ESTA FORZADO, LAS LINEAS QUE DEBERÍAN DE HACERLO SON LAS DE ARRIBA PERO NO VAN, LA LINEA DE DEBAJO LA HEMOS PUESTO NOSOTROS, POR LO MENOS MARCA EL CAMPO AUNQUE SIN MENSAJE.
